    ...
    filter(): this {
        ...
        Object.keys(filterParams).forEach((key) => {
            ...
            if (key.includes(".")) {
                ...
                let nestedCondition: Record<string, unknown> = {};
                ...
                if (Object.keys(nestedCondition).length > 0) {
                    this.query.where = this.deepMerge(this.query.where as Record<string, unknown>, nestedCondition);
                    this.countQuery.where = this.deepMerge(this.countQuery.where as Record<string, unknown>, nestedCondition);
                }
